    ...
    <header className="header">
      <nav className="header-nav container">
        <div className="header-nav__primary">
          <a href="#">
            <img src={HeaderLogo} alt="Turtle Logo" />
          </a>

          <div
            className={`header-nav-menu${active && mobile ? " active" : ""}`}
            onClick={() => handleActive()}
          >
            <span className="header-nav-menu__item" />
            <span className="header-nav-menu__item" />
            <span className="header-nav-menu__item" />
          </div>
        </div>
        ...
        >
          <ul className="header-nav__list">
            ...
            <li className="header-nav__item" onClick={() => handleActive()}>
              <a className="header-nav__link" href="#pricing">
                Pricing
              </a>
            </li>
